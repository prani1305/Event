...
const socialDivReplacement = `<div class="social-icons">
...
files.forEach(file => {
    ...
    // Replace the entire social div everywhere it exists
    content = content.replace(/<div class="social-icons"[\s\S]*?<\/div>\s*<\/div>/g, socialDivReplacement + "\n                </div>");

    fs.writeFileSync(file, content);
});
console.log('Replaced social divs directly');
